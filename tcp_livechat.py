...
tk.Button(root, text="Start as Server", width=20, command=start_server).grid(row=2, column=0, pady=5)
tk.Button(root, text="Connect to Server", width=20, command=connect_to_server).grid(row=2, column=1, pady=5)
